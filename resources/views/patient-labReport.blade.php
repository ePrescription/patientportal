                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="blood">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <select class="form-control" id="selectgerenal"  style="width:200px;float:left;" onchange="javascript:ajaxloadreport(1,{{$patientDetails[0]->patient_id}},this.value);">
...
//alert(hid+pid+date);
        ...
        var BASEURL = "{{ URL::to('/') }}/";
        var status = 1;
        var callurl = BASEURL + 'rest/api/hospital/' + hid + '/patient/' + pid + '/'+date+'/lab-reports';
        $.ajax({
            url: callurl,
            type: "get",
