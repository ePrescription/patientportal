...
.bg-panel{
    ...
    <body class="bg">
        ...
        <section class="header-w3ls"> 
            ...
            <div style="background-color: red">
                <h1><a href=""><img src="images/logo.jpg"  width="150" height="50" alt=""/></a></h1>
            </div>
                            ...
                            <div class="agileits-login">
                                ...
                                <form action="register" method="post">
                                    ...
                                    <form action="{{ url('register') }}" method="post">
                                        ...
                                        <input type="text" name="telephone" placeholder="MobileNumber" required=""/>
                                        <input  id="datepicker3" name="pid" name="Text" type="text" value="" onfocus="this.value = '';" onblur="if (this.value == '') {
                                                    this.value = 'mm/dd/yyyy';
                                                }" placeholder=" DOB mm/dd/yyyy" required="">
    ...
    <center> <h4 style="color:red">{{$sessionmsg}}</h4></center>
...
@endforeach
        ...
        <div class="review-slider">
            ...
            @foreach($hospitals as $hospital)
                ...
                <li>
                    <a href="#"><img src="images/call_us.jpg" alt=""/></a>
                    <div class="slide-title"><h4>Give us a call To {{ $hospital['hospital_name'] }} </h4>
                        <P>{{ $hospital['telephone'] }}</P>
                ...
                <li>
                    <a href="#"><img src="images/send_mes.jpg" alt=""/></a>
                    <div class="slide-title"><h4>Send Mail To {{ $hospital['hospital_name'] }} </h4>
                        <P>{{ $hospital['email'] }}</P>
                        <div class="prom-bottom">
                ...
                <li>
                    <a href="#"><img src="images/loca_i.jpg" alt=""/></a>
                    <div class="slide-title"><h4>{{ $hospital['hospital_name'] }} Location </h4>
                        <P>{{ $hospital['hospital_name'] }}</P>
                        <p>{{ $hospital['address'] }}</p>
                        <div class="prom-bottom">
        ...
        <div class="footer">
            ...
            <div class="agileinfo_footer_bottom1">
                <div class="container">
                    <p>© 2017 Clinical Care. All rights reserved | Powered by <a href="http://glovision.co">Glovision</a></p>
                    <div class="clearfix"> </div>
                </div>
            </div>
        </div>
...
// Slideshow 4
        ...
        <!-- Calendar  <script src="js1/jquery-ui.js"></script>-->
