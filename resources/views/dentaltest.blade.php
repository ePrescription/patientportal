...
<form action="{{URL::to('/')}}/lab/rest/patient/dentaltestresults" role="form" onsubmit="return submitForm(this);" method="POST" class="form-horizontal ">
...
@if($key!=4)
<div class="form-group">
    <label class="col-sm-10 control-label" style="text-align: left; font-size: 14px;">{{$dentalExaminationCategoryValue}}</label>
</div>
