                                    ...
                                    <table border="1">
                                        ...
                                        <tbody>
                                            ...
                                            {{--<tr>--}}
                                                ...
                                                {{--<td class="col-md-3">{{ $doctorappointments[0]->name}}</td>--}}
                                            {{--</tr>--}}
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="col-md-9">Pharmacy Review Summary / Points:</td>
                                                <td class="col-md-3"></td>

                                            </tr>
                                            <tr>
                                                <td class="col-md-9">Pharmacy :</td>
                                                <td class="col-md-3">{{ $doctorappointments[0]->pharmacy}}<br>Address;{{$doctorappointments[0]->pharmacyaddress}}</td>
                                            </tr>
                                            <tr>
                                                <td class="col-md-9">Requested Pickup Date & Time:</td>
