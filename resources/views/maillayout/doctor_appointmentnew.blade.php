                        ...
                        <div >
                            <div class="receipt-right">
                                ...
                                <table border="1">
                                    ...
                                    <tr>
                                        <td class="col-md-9">Date of Appointment:</td>
                                        <td class="col-md-3">{{ $doctorappointments[0]->appointment_date}}</td>
                                    </tr>
                                    <tr>
                                        <td class="col-md-9">Time of Appointment:</td>
                                        <td class="col-md-3">{{ $doctorappointments[0]->time}}</td>

                                    </tr>

                                    <tr>
                                        <td class="col-md-9">Brief Description of Illness:</td>
