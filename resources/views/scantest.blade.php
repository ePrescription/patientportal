...
<form action="{{URL::to('/')}}/lab/rest/patient/scantestresults" role="form" onsubmit="return submitForm(this);"  method="POST" class="form-horizontal" id="motion">
    ...
    @foreach($patientScans as $patientScanValue)
        <div class="col-sm-6 form-group">
            <label class="col-sm-6 control-label">{{$patientScanValue->scan_name}}</label>
            <div class="col-sm-6">
