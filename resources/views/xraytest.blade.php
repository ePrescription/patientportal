...
<script>
    ...
    function changeValues(did) {
        var dateValue = $("#xrayTestDate").val();
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.result['result'] == "Doctor Is Not Available") {
                        ...
                        $("#xrayexaminationTime").html(terms);
                    } else {
    ...
    function loaddoctor(hid) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#xraydoctorId").html(list);
            }
        });
    }

    function submitForm() {
        var hospitalId= $('#xrayhospitalId').val();
                    ...
                    @if(count($xrayExaminations)>0)
                        ...
                        <form action="{{URL::to('/')}}/lab/rest/patient/xraytestresults" role="form" method="POST" onsubmit="return submitForm(this);" id="xray" class="form-horizontal ">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="hospitalId" id="xrayhospitalId" onchange="loaddoctor(this.value)"  class="form-control input-md" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="doctorId" id="xraydoctorId" onchange="changeValues(this.value)"  class="form-control input-md">
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="examinationDate" id="xrayTestDate" value="{{date('Y-m-d')}}" style="line-height: 20px;" required="required" onchange="changeTimeSlots(this.value);" />
                                    @if ($errors->has('examinationDate'))<p class="error" style="">{!!$errors->first('examinationDate')!!}</p>@endif
                                </div>
                                <div class="col-sm-4">
                                    <select class="form-control" name="examinationTime" id="xrayexaminationTime"
                                            required="required">
