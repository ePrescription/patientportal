...
<form action="{{URL::to('/')}}/lab/rest/patient/bloodtestresults" role="form" method="POST" onsubmit="return submitForm(this);" class="form-horizontal " id="blood">
